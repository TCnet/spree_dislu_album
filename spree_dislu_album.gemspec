...
require 'spree_dislu_album/version'

Gem::Specification.new do |s|
  s.platform    = Gem::Platform::RUBY
  s.name        = 'spree_dislu_album'
  s.version     = SpreeDisluAlbum.version
  ...
  s.homepage  = 'https://github.com/your-github-handle/spree_dislu_album'
